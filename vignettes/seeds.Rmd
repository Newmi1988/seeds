...
Both algorithm make heavy use of the deSolve package and Rtools to compile the given models.
...
The algorithm can be executed in a smiliar fashion as the sgdn algorithm. However computational time is much higher. See demostrations on how to use the algorithm. For further information look into the documentation of the functions.
