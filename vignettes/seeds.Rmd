...
Rtools is suggested, because of the immense computational cost of the step size estiamtion of the gradient step.
...
- **resetValue**: value a state should be set to by an event (optinal)
