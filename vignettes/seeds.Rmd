...
## The DEN (dynamic elstic net) Algorithm
...
The algorithm can be executed in a smiliar fashion as the DEN algorithm. However computational time is much higher. See demonstration on how to use the algorithm. For further information look into the documentation of the functions.
